...
export const AppEnv: AppEnvType = {
    ...
    CLOUD_STORAGE_IMAGE_BUCKET_NAME:
        process.env.CLOUD_STORAGE_IMAGE_BUCKET_NAME,
    CLOUD_STORAGE_IMAGE_BUCKET_PROTOCOL:
        process.env.CLOUD_STORAGE_IMAGE_BUCKET_PROTOCOL,
    CLOUD_STORAGE_IMAGE_BUCKET_HOST:
        process.env.CLOUD_STORAGE_IMAGE_BUCKET_HOST,

    IMAGE_OPTIMIZATION_API_PROTOCOL:
        process.env.IMAGE_OPTIMIZATION_API_PROTOCOL,
